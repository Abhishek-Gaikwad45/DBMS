...
mysql> insert into emp values(1,'abhishek',2456.22,'clerk',101,'A');
Query OK, 1 row affected (0.15 sec)
mysql> insert into emp values(2,'chetan',6447.18,'manager',102,'A+');
Query OK, 1 row affected (0.04 sec)
mysql> insert into emp values(3,'piyush',7345.68,'A.engi',103,'B');
Query OK, 1 row affected (0.02 sec)
mysql> select *from emp;
+------+--------+---------+---------+------+-------+
| id   | name   | salary  | desg    | dno  | grade |
+------+--------+---------+---------+------+-------+
|    1 | abhi   | 2456.22 | clerk   |  101 | A     |
|    2 | chetan | 6447.18 | manager |  102 | A+    |
|    3 | piyush | 7345.68 | A.engi  |  103 | B     |    |
+------+--------+---------+---------+------+-------+
...
mysql> source /home/abhishek/cursor.sql
