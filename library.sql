...
+------+------+--------+------+
1 row in set (0.00 sec)
mysql> insert into student_book(rno,bid,doi) values(4,104,'2020-05-23');
...
mysql> call update_amount(4,104,'2020-06-29');
...
+------+------+--------+------+
3 rows in set (0.00 sec)
mysql> call update_amount(1,101,'2021-10-30');
Query OK, 1 row affected (0.02 sec)
mysql> select *from student_book;
+------+------+------------+------------+
| rno  | bid  | doi        | dor        |
+------+------+------------+------------+
|    6 |  106 | 2020-03-15 | 2020-04-10 |
|    4 |  104 | 2020-05-23 | 2020-06-29 |
|    1 |  101 | 2021-09-15 | 2021-10-30 |
+------+------+------------+------------+
3 rows in set (0.00 sec)
mysql> select *from book_fine;
+------+------+--------+------+
...
+------+------+--------+------+
3 rows in set (0.00 sec)
mysql> insert into student_book(rno,bid,doi) values(3,103,'2021-03-10');
Query OK, 1 row affected (0.02 sec)
mysql> call update_amount(3,103,'2021-03-24');
Query OK, 1 row affected (0.02 sec)
mysql> select *from student_book;
+------+------+------------+------------+
| rno  | bid  | doi        | dor        |
